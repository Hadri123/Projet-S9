...
img2 = cv2.imread("D:\python_code\Images\m3.png")
img = cv2.imread("D:\python_code\Images\sou.png")
...
for face in faces2:
    ...
    for n in range(0,68):
        ...
        #cv2.circle(img2, (x,y),3, (255,0,255), -1)
...
#triangulisation of the second face, from the first face 
    ...
    for triangle_index in indexes_triangles:
        ...
        cv2.line(img, tr1_pt1, tr1_pt2, (0,0,150), 2)
        cv2.line(img, tr1_pt2, tr1_pt3, (0,0,150), 2)
        cv2.line(img, tr1_pt3, tr1_pt1, (0,0,150), 2)  
        ...
        # cv2.line(img2, tr2_pt1, tr2_pt2, (0,0,150), 2)
        # cv2.line(img2, tr2_pt2, tr2_pt3, (0,0,150), 2)
        # cv2.line(img2, tr2_pt3, tr2_pt1, (0,0,150), 2)  
...
# cv2.imshow("im2", img2) 
# cv2.imshow("IM",img)
# cv2.imshow("warped", img2_new_face)
